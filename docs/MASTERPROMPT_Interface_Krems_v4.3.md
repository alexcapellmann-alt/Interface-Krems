# Masterprompt: Interface Stadtarchiv Krems – Neuarchitektur (v4.3, eingefroren)
...
**Änderungen gegenüber v4.2 (Klarstellung nach Etappe 5):** Allgemeine Regel ergänzt, wie mit "undatiert"/"nicht zuordenbar" umzugehen ist, wenn eine räumlich getrennte Fläche (wie beim Gantt-Diagramm) strukturell nicht möglich ist (z. B. Marimekko, Alluvial-Diagramme).
